...
export default function About() {
  return (
    <PageLayout title="Willow Lancaster">
      ...
      <p>When I'm not messing with software or circuits I can typically be found hiking, flying around in a sim, or playing music on my small collection of strange instruments.</p>
    </PageLayout>
  )
}
