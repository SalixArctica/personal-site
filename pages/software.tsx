...
const Software = () => {
  return (
    <PageLayout title="Software I've helped make">
      <Card img="mux.png" href="https://mux.com">
        <h1>Mux Dashboard</h1>
      ...
      <Card img="jb-hunt.jpeg" href="https://www.jbhunt.com/our-technology/shipper-360">
        <h1 >JB Hunt 360</h1>
      ...
      <Card img="garret-and-co.png" href="https://www.garrettandco.com/">
      ...
      <Card img="new-hope.png" href="https://newhopemannford.org/">
        <h1>New Hope</h1>
